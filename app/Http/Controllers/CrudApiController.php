...
class CrudApiController extends Controller
{
    ...
    public function store(Request $request){
        ...
        if ($validator->fails()) {
            return redirect()->route('crudapis.create') // Gantilah 'nama_routemu' dengan nama route Anda
        ...
        if ($qry) {
            ...
            return redirect()->route('crudapis.index');       
        }
    }
    public function destroy($id) {
        ...
        if (!$barang) {
            ...
            return redirect()->route('crudapis.index')->with('error', 'Data tidak ditemukan');
        }
