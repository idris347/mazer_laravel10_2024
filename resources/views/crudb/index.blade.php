...
<div class="card">
    ...
    <div class="card-header">
        <a href="{{ route('crudb.create') }}" class="btn btn-primary rounded-pill">Tambah data</a>
    </div>
    @php
        $no = 1;
    @endphp
                ...
                <tbody>
                    @foreach ($data as $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('crudb.edit',$item->id)}}" class="btn icon btn-primary"><i class="bi bi-pencil"></i></a>
