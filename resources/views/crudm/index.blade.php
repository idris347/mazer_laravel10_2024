...
<div class="page-title">
    <div class="row">
        <div class="col-12 col-md-6 order-md-1 order-last">
            <h3>Crud Modal</h3>
            <p class="text-subtitle text-muted">Crud yang menampilkan tambah data dan edit data berupa pop up modal</p>
        </div>
...
<div class="card">
    ...
    <div class="card-header ms-auto">
            ...
            data-bs-target="#default" class="btn btn-primary rounded-pill">Tambah data</a>
                ...
                <tbody>
                    @foreach ($data as $item)
                        <tr>
                            ...
                            <td>
                                <a href="button" data-bs-toggle="modal" data-bs-target="#default1"  class="btn icon btn-primary" ><i class="bi bi-pencil"></i></a>
